# [2.225.0-dev.1](https://github.com/Francesco146/revanced-patches/compare/v2.224.0...v2.225.0-dev.1) (2024-08-04)


### Bug Fixes

* **Change version code:** Change to a universal patch ([11a00ca](https://github.com/Francesco146/revanced-patches/commit/11a00ca5c046806124b6441904ce66df3ce002a6))
* **Custom branding icon:** Failed because of missing resources ([5e0723e](https://github.com/Francesco146/revanced-patches/commit/5e0723e52856a93f06f798b1fc18e18bbfa56490))
* **GmsCore support:** Spoof package name ([9c4e70c](https://github.com/Francesco146/revanced-patches/commit/9c4e70cf896e1ca9efc6c9b3766eca7c6869a413))
* **Hide ads:** app crashes in the old client ([2a61d08](https://github.com/Francesco146/revanced-patches/commit/2a61d08cb59d76115d0f0ddd7deecc8e02a245dc))
* Patch error due to invalid strings ([5069303](https://github.com/Francesco146/revanced-patches/commit/5069303f9dcc08a56a3d8582832db8f869e7245b))
* Patching failed because of RVX CLI incompatibility ([922d364](https://github.com/Francesco146/revanced-patches/commit/922d36408b74dc7f9b085e656564df9f01a406ab))
* **Reddit - Change version code:** `Version code` option is not available in RVX Manager ([9a4788d](https://github.com/Francesco146/revanced-patches/commit/9a4788d1c0dc089088990e8d561cd8c976b4ed55))
* **Reddit - Hide toolbar button:** Latest version support information ([#378](https://github.com/Francesco146/revanced-patches/issues/378)) ([0c0752d](https://github.com/Francesco146/revanced-patches/commit/0c0752d6df50549578dcd0b3ea5c0288e8a6d8d0))
* **Reddit - Settings:** Patch option `RVX settings menu name` does not apply to header in ReVanced Extended settings ([4827a0f](https://github.com/Francesco146/revanced-patches/commit/4827a0fa0b1ee8f576fa1020f9a0378b79cdf9cc))
* **Settings:** Failed with custom RVXSettingsMenuName ([c0d3ed0](https://github.com/Francesco146/revanced-patches/commit/c0d3ed0b377f018913d217962088e935084c167c))
* **Shorts components:** `Hide sound button` doesn't work (A/B tests) ([234feb7](https://github.com/Francesco146/revanced-patches/commit/234feb786b9b391815a2555c0a49aff66b66e5cf))
* Update broken Translations ([f2c2b21](https://github.com/Francesco146/revanced-patches/commit/f2c2b21821a497c8a88de9085f47b9c20c93a2e9))
* **YouTube - Client spoof:** Some side effects of iOS client ([823711e](https://github.com/Francesco146/revanced-patches/commit/823711e84bc95b88faa620690ee0fb0960b93808))
* **YouTube - Custom branding icon:** Add `Revancify Yellow` to patch options ([aea7060](https://github.com/Francesco146/revanced-patches/commit/aea70604ae326ec86ddec5b37d03a06673292545))
* **YouTube - Custom Branding Icon:** Add missing strings to prevent patch failure ([84e2cb5](https://github.com/Francesco146/revanced-patches/commit/84e2cb52c250fb6c2fb69bc3a0462ca880a8c9a5))
* **YouTube - Custom branding icon:** MMT splash icon were missing ([6f29eec](https://github.com/Francesco146/revanced-patches/commit/6f29eecd0a98016e65492df8a47942ab1f0e2cb9))
* **YouTube - Custom branding icon:** Patch failed for some icons ([97bc461](https://github.com/Francesco146/revanced-patches/commit/97bc461be57e5ed4f37dd56b3df19cfb933b4d39))
* **YouTube - Custom branding:** Fix patch error regarding `Xisr Yellow` ([dae0a79](https://github.com/Francesco146/revanced-patches/commit/dae0a793acd2c50e8bda2c8809d3e377101d8c41))
* **YouTube - Custom Branding:** Fixed broken splash animation for `Xisr Yellow` ([#758](https://github.com/Francesco146/revanced-patches/issues/758)) ([b5ea4b1](https://github.com/Francesco146/revanced-patches/commit/b5ea4b1f41a43d8ab473bea0212d7f42564dd5b5))
* **YouTube - Custom Branding:** Patch fails when selecting some custom icons ([3660723](https://github.com/Francesco146/revanced-patches/commit/36607234cb8755d9e703d342674284dc2dbd4c8c))
* **YouTube - Custom header for YouTube:** Custom headers do not change (A/B tests) ([7b3e52d](https://github.com/Francesco146/revanced-patches/commit/7b3e52d4fefa5f67add79b47cbca84b62108070c))
* **YouTube - Default video quality:** Fix `Skip preloaded buffer` ([fb54626](https://github.com/Francesco146/revanced-patches/commit/fb54626ee6c0d7b7033b796b5317f0abdd299893))
* **YouTube - Disable auto captions:** Turning on `Disable forced auto captions` will disable subtitles ([f4dc6d3](https://github.com/Francesco146/revanced-patches/commit/f4dc6d39b75a61ae954cc7657551535499826f5f))
* **YouTube - Disable forced auto captions:** Subtitles don't work after playing Shorts ([b1d091f](https://github.com/Francesco146/revanced-patches/commit/b1d091f96107936cd48b56cf20cb257c2e9de61e))
* **YouTube - Disable splash animation:** Did not work on YouTube v19.17.41+ ([d2182be](https://github.com/Francesco146/revanced-patches/commit/d2182be8e8feeb2640fe9aea1e90b7a265aa0d3b))
* **YouTube - Hide ads:** `Hide ads` patch does not work on YouTube 18.29.38 ([c150ab2](https://github.com/Francesco146/revanced-patches/commit/c150ab2be85aa56de28cbff9f32eed2a69fa8688))
* **YouTube - Hide feed components:** Sometimes `Hide carousel shelf` setting doesn't work ([f53ce46](https://github.com/Francesco146/revanced-patches/commit/f53ce46c1461ac8699af767f03f92a20e7c1ed65))
* **YouTube - Hide Shorts components:** Exclude `Hide sound metadata label` and `Hide video link label` from `Hide info panel` ([4f5bdcc](https://github.com/Francesco146/revanced-patches/commit/4f5bdccacee834782525fdcc9367ed39106fa4a8))
* **YouTube - Miniplayer:** `Hide expand and close buttons` setting is not disabled in `Modern 1` on YouTube 19.20.35+ ([b7c330a](https://github.com/Francesco146/revanced-patches/commit/b7c330ace90f9761cd06322eb0840b593d1e26d1))
* **YouTube - Overlay buttons:** `Mute Volume` button was black when light theme is enabled ([ad99667](https://github.com/Francesco146/revanced-patches/commit/ad99667ab1b5dc6fa8256978c024f05bbbcc552c))
* **YouTube - Overlay buttons:** Image of the `Mute video` button is reversed ([9b5ebab](https://github.com/Francesco146/revanced-patches/commit/9b5ebab8e857fb163e26019353a3001f7eb3457f))
* **YouTube - Return YouTube Dislike:** Dislike count sometimes not shown in Shorts ([d821384](https://github.com/Francesco146/revanced-patches/commit/d82138474e4a544deb5fc37ddd77b87e35b14bbe))
* **YouTube - Return YouTube Dislike:** Fix some RYD issues ([32d6c25](https://github.com/Francesco146/revanced-patches/commit/32d6c254ffffbc8b09bbf45890cd39488f396123))
* **YouTube - Settings Custom Name:** Fix resource files not found ([#416](https://github.com/Francesco146/revanced-patches/issues/416)) ([cc4566a](https://github.com/Francesco146/revanced-patches/commit/cc4566a5499ce7fbe95c82d4c5d27e12fc671c1b))
* **YouTube - Settings:** `CairoSettings` is applied due to A/B testing ([bad0f92](https://github.com/Francesco146/revanced-patches/commit/bad0f929853890eaac7a21a4faaad5cf43077f74))
* **YouTube - Settings:** Some settings were duplicated ([4e7d994](https://github.com/Francesco146/revanced-patches/commit/4e7d994ff8805aa602326357135669a2a9e37375))
* **YouTube - Settings:** Toolbar added twice to RVX settings ([6346a5e](https://github.com/Francesco146/revanced-patches/commit/6346a5e7687cf37f7ce175a30c32c2c9df584f3a))
* **YouTube - SponsorBlock:** `Submit a new segment` button didn't work ([c7e39b3](https://github.com/Francesco146/revanced-patches/commit/c7e39b3312b4863085eddf6534736c40afd3691a))
* **YouTube - SponsorBlock:** Skip segments when casting ([a40bbcb](https://github.com/Francesco146/revanced-patches/commit/a40bbcb85447673c52eef94874148ebcf3bb6c16))
* **YouTube - Spoof client:** Player gestures not working when spoofing with `Android VR` client ([0cdc4f3](https://github.com/Francesco146/revanced-patches/commit/0cdc4f33c98cc16f5a302f2ca46a93434165bfd3))
* **YouTube - Spoof client:** Restore playback speed menu when spoofing to an iOS, Android TV, Android Testsuite client ([06ffb15](https://github.com/Francesco146/revanced-patches/commit/06ffb15d8bf5b91fa98910d975d3ad887e609789))
* **YouTube - Spoof client:** Seekbar thumbnail not shown in `Android Testsuite` client ([74d50b1](https://github.com/Francesco146/revanced-patches/commit/74d50b1b5ad5860a4f341039e953a7c38b457afb))
* **YouTube - Spoof format stream data:** Check audio tags first ([5589897](https://github.com/Francesco146/revanced-patches/commit/5589897793d6a6f7e34980ed9b32d051267af48d))
* **YouTube - Spoof format stream data:** Incorrect url is used ([928b459](https://github.com/Francesco146/revanced-patches/commit/928b459fbd98ed5cc3b63260caef268c882f50a9))
* **YouTube - Spoof format stream data:** Some Uris are not hooked ([e682654](https://github.com/Francesco146/revanced-patches/commit/e6826546533a2c1adb767b29875663291362fab0))
* **YouTube - Spoof test client:** Spoofing does not work correctly when the `Spoof app version` setting is turned on ([33292a0](https://github.com/Francesco146/revanced-patches/commit/33292a07279602ab7f8e35fd9a23c5172a4b9b9a))
* **Youtube - Tablet Miniplayer:** Broken controls ([#386](https://github.com/Francesco146/revanced-patches/issues/386)) ([1b60113](https://github.com/Francesco146/revanced-patches/commit/1b601130b5bcb3dfa03f590fbc512dbf6a4b841d))
* **YouTube - Theme:** Reverts background color of `More comments` icon in live chats ([3c7f976](https://github.com/Francesco146/revanced-patches/commit/3c7f9764c18eed33b6577e20f86c45df94a82091))
* **YouTube - Toolbar components:** Turning on the `Hide voice search button` setting makes the margin of the searchbar 0 ([ca02dba](https://github.com/Francesco146/revanced-patches/commit/ca02dba30710decc4ddea07318e72a9966124665))
* **YouTube - Translations:** Language `de-rDE` was giving warnings during compilation ([20617d5](https://github.com/Francesco146/revanced-patches/commit/20617d51937c6117de0bd4735bf65e6cd4fa5ef4))
* **YouTube - Translations:** Remove duplicates caused error ([5e904c0](https://github.com/Francesco146/revanced-patches/commit/5e904c005cb881e8113eb7d41a87c7e738620eb6))
* **YouTube - Translations:** Removed some languages from UI ([93279da](https://github.com/Francesco146/revanced-patches/commit/93279da02684887dbb1f25668f64f49f2ca55391))
* **YouTube - Video playback:** Default video quality does not apply ([04fa20d](https://github.com/Francesco146/revanced-patches/commit/04fa20da4dfff3772904be3e8be634a1f3c492e0))
* **YouTube - Video playback:** Default video quality does not apply to Shorts ([eb53500](https://github.com/Francesco146/revanced-patches/commit/eb53500fb6dc5f07bb36bb6abf531ee61545419f))
* **YouTube - Visual preferences icons:** Add missing `Custom branding icons` ([27efd27](https://github.com/Francesco146/revanced-patches/commit/27efd27bc0296ba43445a0ece90dbf81bf69706d))
* **YouTube - VIsual preferences icons:** Revert ([c002788](https://github.com/Francesco146/revanced-patches/commit/c00278891f01b2a197674c79a9bf27341edfd47b))
* **YouTube - Visual preferences icons:** Typo in QUIC ([409e283](https://github.com/Francesco146/revanced-patches/commit/409e2831b3c1ab9db1023e5f6257d4d4d327a592))
* **YouTube Music - Hide ads:** `Hide fullscreen ads` setting also closes non-ad dialogs ([8d03e3f](https://github.com/Francesco146/revanced-patches/commit/8d03e3f99d40410def975db79761bfb00c56fa01))
* **YouTube Music - Visual preferences icons:** Add missing `Custom branding icons` ([52d581c](https://github.com/Francesco146/revanced-patches/commit/52d581cc48567b46fa496375b7e079774bd7942c))
* **YouTube Music - Visual preferences icons:** Add missing custom branding icons ([1071471](https://github.com/Francesco146/revanced-patches/commit/10714717b69710f7c5eb364cb7d0a604c00dae55))
* **YouTube/Overlay buttons:** in devices that do not use `xxhdpi`, some buttons are not replaced correctly ([030b2f6](https://github.com/Francesco146/revanced-patches/commit/030b2f6fa43ce280266ce45a2f2272aa4d1c1eda))
* **YouTube:** `Ambient mode control` patch does not work correctly on certain versions ([0f9f79e](https://github.com/Francesco146/revanced-patches/commit/0f9f79e5c4e7645ae9d788f92a966b59043b5c52))
* **YouTube:** `Hide animated button background` patch doesn't work ([37fac01](https://github.com/Francesco146/revanced-patches/commit/37fac01c5b173fbbdfa9c44043b086836cbb36cd))
* **YouTube:** Bring back missing strings ([d47016a](https://github.com/Francesco146/revanced-patches/commit/d47016aa954d9dc9c308f7207818dbf29a8a5d80))
* **YouTube:** Fix app crashing for some people by reverting fix Shorts looping for some people ([a6f5dd5](https://github.com/Francesco146/revanced-patches/commit/a6f5dd5d997bd25c8bac130ed5135e57fc74bd9f))
* **YouTube:** Separate `Hide info panels` and `Hide Shorts info panels` ([808d3fb](https://github.com/Francesco146/revanced-patches/commit/808d3fb89cb27a2d317be2d1f54933aef95b32dc))
* **YouTube:** Speed toast showed fixed value on reset ([2aae719](https://github.com/Francesco146/revanced-patches/commit/2aae7197aa517f36f0d614b7b419382191d9f1e8))
* **YT Music - Translations:** Use correct resource directory ([78667fa](https://github.com/Francesco146/revanced-patches/commit/78667fa54654fc68d26042c45cdbb9f5f0ccc187))


### Features

* **Custom branding icon:** Add `Revancify Yellow` icon ([#533](https://github.com/Francesco146/revanced-patches/issues/533)) ([d3bdd97](https://github.com/Francesco146/revanced-patches/commit/d3bdd97c8afc205fca85627740d3da498afb2121))
* **Custom Branding Icons:** Change default icon to `Revancify Yellow` ([#752](https://github.com/Francesco146/revanced-patches/issues/752)) ([60163db](https://github.com/Francesco146/revanced-patches/commit/60163dbde9d90035763ed66827515485393e6b4d))
* **GmsCore support:** Add `Don't show again` option for battery optimization dialog ([3069354](https://github.com/Francesco146/revanced-patches/commit/3069354e5e736dbbebc1a85cdde2762a436f1338))
* **Hide ads:** Add `Close fullscreen ads` settings ([a9fc181](https://github.com/Francesco146/revanced-patches/commit/a9fc181507e8e56f9d29e1ab97061fec1455100a))
* Merge RVX v4.10.1 ([#691](https://github.com/Francesco146/revanced-patches/issues/691)) ([a305ca9](https://github.com/Francesco146/revanced-patches/commit/a305ca95c32ba69a513c9ce9bf681d3a414f16f9))
* Merge RVX v4.10.2-dev.1 ([eb5f944](https://github.com/Francesco146/revanced-patches/commit/eb5f9449daf1dcbe8ce1c51b39e3371e7f2146b2))
* Merge the `Custom package name` patch into the `GmsCore support` patch and add patch options `GmsCoreVendorGroupId`, `CheckGmsCore`, `PackageNameYouTube`, `PackageNameYouTubeMusic` ([2b4931a](https://github.com/Francesco146/revanced-patches/commit/2b4931a2151984c57b0f9d3f660ccadd502609ca))
* **Reddit/Settings for Reddit:** add patch option `RVX settings menu name` ([5d51d81](https://github.com/Francesco146/revanced-patches/commit/5d51d815a7d4948f17ee4133d818492cb406f61d))
* **Reddit:** Add `Change version code` patch ([ec7da6d](https://github.com/Francesco146/revanced-patches/commit/ec7da6d5c7f46cfc51a6b7121e712d1db3670b13))
* **Reddit:** Add `Hide recommended communities shelf` patch ([3a07f0a](https://github.com/Francesco146/revanced-patches/commit/3a07f0a379e500b03dcdb265136d79360fc313b6))
* Refactor and match ReVanced and inotia ([5b4dca0](https://github.com/Francesco146/revanced-patches/commit/5b4dca03970f887f6caaf3da072ff77276754a61))
* **YouTube - Alternative thumbnails:** Add alternative domain ([5a86268](https://github.com/Francesco146/revanced-patches/commit/5a86268e7d5ae785f8cf6b81d4a1c120dfd0c542))
* **YouTube - Bypass image region restrictions:** Bring back setting to change alternative domain ([a037281](https://github.com/Francesco146/revanced-patches/commit/a037281dd1da76fd55ee5e3f537e99c8ffe1199f))
* **YouTube - Collapse Button:** Hide collapse button margin ([#415](https://github.com/Francesco146/revanced-patches/issues/415)) ([6419978](https://github.com/Francesco146/revanced-patches/commit/6419978ce76fa48cbf157bf4a752af7c291a63c8))
* **YouTube - Custom branding icon:** Add `MMT Blue`, `MMT Green`, `MMT Yellow` ([941216e](https://github.com/Francesco146/revanced-patches/commit/941216eff18351580ac665fe49300432729aba26))
* **YouTube - Custom branding icon:** Add new splash animations for all `Revancify` icons ([#629](https://github.com/Francesco146/revanced-patches/issues/629)) ([2d2e504](https://github.com/Francesco146/revanced-patches/commit/2d2e5045c94f409559e46f6871eabb64407d9443))
* **YouTube - Custom branding icon:** Add old splash animation for `Revancify Red` and `Revancify Blue` ([ed2da7e](https://github.com/Francesco146/revanced-patches/commit/ed2da7e36a64a4b2aa653281ed7e762f7a0dd7b7))
* **YouTube - Custom branding icon:** Add splash animation for `Revancify Blue`, `Revancify Red` and `Revancify Yellow` ([95fed8c](https://github.com/Francesco146/revanced-patches/commit/95fed8c986966f187e016d56d1c969db0ce9141b))
* **YouTube - Custom branding icon:** Add splash animations for AFN Blue and AFN Red ([f5c0178](https://github.com/Francesco146/revanced-patches/commit/f5c0178befc0d38998bd7f9d660d1147786bf549))
* **YouTube - Custom branding icon:** Custom header support for `Revancify Yellow` ([#656](https://github.com/Francesco146/revanced-patches/issues/656)) ([72dfa7e](https://github.com/Francesco146/revanced-patches/commit/72dfa7e2d00e65d027eb0ff423764f79d04f1018))
* **YouTube - Custom branding icon:** Update old splash animation for `Revancify Red` and `Revancify Blue` ([ff70195](https://github.com/Francesco146/revanced-patches/commit/ff7019555f536e530d5406469d22ac21dced11dd))
* **YouTube - Custom Shorts action buttons:** Add `YouTube` (unchanged) to selectable patch options ([0b77187](https://github.com/Francesco146/revanced-patches/commit/0b77187699f5c045f8f316dc5cad0c09ccf1917a))
* **YouTube - Default Quality & Speed:** Add an option to disable toasts when changing the default values ([cc95f31](https://github.com/Francesco146/revanced-patches/commit/cc95f316485fe1759621b37471980c0ffe14d7cd))
* **YouTube - Description components:** Add `Hide Contents section` setting ([e8358ff](https://github.com/Francesco146/revanced-patches/commit/e8358ffc680693e2923e3c03933b9fcfb0874eb7))
* **YouTube - Download Playlist Button:** Add playlist download button ([#761](https://github.com/Francesco146/revanced-patches/issues/761)) ([449d45a](https://github.com/Francesco146/revanced-patches/commit/449d45aaff4be67937a89c177f3e6ee8b8e5d489))
* **YouTube - Force player buttons background:** Add an option to change the color and opacity of the player buttons' background ([eab9795](https://github.com/Francesco146/revanced-patches/commit/eab979534b5b98fb532a3c6ad79d338e8f23ab4c))
* **YouTube - Force snackbar theme:** Add options for corner radius, background and stroke colors ([eafb7b2](https://github.com/Francesco146/revanced-patches/commit/eafb7b222c2a39ff2a301a3975838e3e675529a8))
* **YouTube - Fullscreen components:** `Hide related videos in quick actions` setting has been merged into the `Hide related video overlay` setting ([bdcee27](https://github.com/Francesco146/revanced-patches/commit/bdcee27c001b3e738c7c7c7dde3c7c5888be14d7))
* **YouTube - Hide feed components:** Add `Match full word` option for keyword filtering ([cd12a83](https://github.com/Francesco146/revanced-patches/commit/cd12a838b1e1f87c18af0f06fd0b1cd09974a8fb))
* **YouTube - Hide layout components:** Add `Hide videos based on duration` ([ebd6955](https://github.com/Francesco146/revanced-patches/commit/ebd69550544d5446bdd98a4257912bd18ec478ef))
* **YouTube - Hide layout components:** Add an option to hide videos with views greater than specified value ([98c2f99](https://github.com/Francesco146/revanced-patches/commit/98c2f9942dd03f48aee00013307533430306152f))
* **YouTube - Hide player flyout menu:** Add `Hide quality menu header` ([99af80b](https://github.com/Francesco146/revanced-patches/commit/99af80be0c5d84433cae983fa694e6ad48906e4a))
* **YouTube - Hide shorts components:** Add separate option to hide in player ([7b60297](https://github.com/Francesco146/revanced-patches/commit/7b60297b0ed5096a9f7533837691d96df4809630))
* **YouTube - Hide shorts components:** Hide comments button if disabled or with label "0" ([299e20b](https://github.com/Francesco146/revanced-patches/commit/299e20b774408d6f8ec9dc3c6e4274cf43db0bc5))
* **YouTube - Miniplayer:** Add `Enable double-tap action` setting ([157f25a](https://github.com/Francesco146/revanced-patches/commit/157f25a94a7d5aa0be46d9c39efd8b088a713806))
* **YouTube - Miniplayer:** Add `Enable drag and drop` setting (YouTube 19.23.40+) ([fa0ac0f](https://github.com/Francesco146/revanced-patches/commit/fa0ac0fc5dd710ed50f232c67820527e23cd9838))
* **YouTube - Navigation bar components:** Add `Enable translucent navigation bar` setting ([e9ff3c9](https://github.com/Francesco146/revanced-patches/commit/e9ff3c9aa61ea0d4090e02e1fe9722d96cee9841))
* **YouTube - Overlay buttons:** Add `Mute Video` button ([#684](https://github.com/Francesco146/revanced-patches/issues/684)) ([fb26c7a](https://github.com/Francesco146/revanced-patches/commit/fb26c7a1d9044780158db771cc05dc50115bb3a8))
* **YouTube - Overlay buttons:** Add `Rounded` (old curvy) buttons ([73ab950](https://github.com/Francesco146/revanced-patches/commit/73ab950ce251e673860826cf32239c451de64122))
* **YouTube - Overlay buttons:** Add `Whitelist` overlay button ([358af9e](https://github.com/Francesco146/revanced-patches/commit/358af9ee3914bb6912c8f56934cc0d8418a52ce8))
* **YouTube - Overlay buttons:** Add content descriptions to overlay buttons for improved accessibility ([4d61417](https://github.com/Francesco146/revanced-patches/commit/4d6141776c6255bf4fc31173dbedd4fe9cec188f))
* **YouTube - Overlay buttons:** Add patch option `Change top buttons` ([504a1fe](https://github.com/Francesco146/revanced-patches/commit/504a1fe46ae97b7b328c4245941c69be698bb4f3))
* **YouTube - Player components:** `Hide player popup panels` setting now hides the products panel ([e96317b](https://github.com/Francesco146/revanced-patches/commit/e96317b703bc645b657ae697ed2790645bd54d7c))
* **YouTube - Player components:** Add `Hide zoom overlay` setting ([00640e6](https://github.com/Francesco146/revanced-patches/commit/00640e661753802439dfba65827307e7e703fb14))
* **YouTube - Player components:** Add setting toggle for `Hide suggested video end screen` ([f4a9c22](https://github.com/Francesco146/revanced-patches/commit/f4a9c221e128e399e9667b3474d542b84ba9252e))
* **YouTube - Searchbar:** Change cursor color dynamically ([#675](https://github.com/Francesco146/revanced-patches/issues/675)) ([e5babda](https://github.com/Francesco146/revanced-patches/commit/e5babda4e8f1fd054ad08bee948f22c8a735cb84))
* **YouTube - Searchbar:** Complete restyle ([#652](https://github.com/Francesco146/revanced-patches/issues/652)) ([8458e1a](https://github.com/Francesco146/revanced-patches/commit/8458e1ae561622d2a49a4dc3e71bb9157f2e153e))
* **YouTube - Seekbar components:** Add `Enable Cairo seekbar` setting (YouTube 19.23.40+) ([95ed714](https://github.com/Francesco146/revanced-patches/commit/95ed714c4ef0bf3c88ab534ebb00e7b6e83b41d4))
* **YouTube - Settings:** Add custom name for Extended preference ([#389](https://github.com/Francesco146/revanced-patches/issues/389)) ([8804b92](https://github.com/Francesco146/revanced-patches/commit/8804b924ac5db841e458e62cfe69be8424e3b968))
* **YouTube - Settings:** Add search bar for settings ([85cf0c0](https://github.com/Francesco146/revanced-patches/commit/85cf0c016a20b4fb67c0a7aa1176fdce87d3ad48))
* **YouTube - Settings:** Change cursor color dynamically in searchbar ([5133265](https://github.com/Francesco146/revanced-patches/commit/51332654c1e8419ccaa802f90e5bdb9e40fe9f96))
* **YouTube - Settings:** Improved sorting of settings ([fc8bb8c](https://github.com/Francesco146/revanced-patches/commit/fc8bb8c350955ffed7d1850b8b94719577a24891))
* **YouTube - Settings:** Make `InsertPosition` case-insensitive and interchangeable between Setting name and Setting key ([#713](https://github.com/Francesco146/revanced-patches/issues/713)) ([269dc50](https://github.com/Francesco146/revanced-patches/commit/269dc50f707e6e15ff95a956dad34b4151860649))
* **YouTube - Settings:** Show AlertDialog when changing some settings value (matches ReVanced) ([3f301e0](https://github.com/Francesco146/revanced-patches/commit/3f301e0c4226d77098424b74b44dcb5ebf0ba189))
* **YouTube - Shorts components:** Add `Double-tap animation` settings ([a1868ec](https://github.com/Francesco146/revanced-patches/commit/a1868ecae8f74ca9d14a616707a5c94058d79591))
* **YouTube - Shorts components:** Add `Enable timestamps`, `Timestamp long press action`, `Meta panel bottom margin` settings ([ad087ff](https://github.com/Francesco146/revanced-patches/commit/ad087ff2bc184b2cf9eb76e02c4dad719f2c6896))
* **YouTube - Shorts components:** Add `Hide paused header` setting ([b044b61](https://github.com/Francesco146/revanced-patches/commit/b044b61242c7e4200373debc57975482b81c070b))
* **YouTube - Shorts components:** Add `Hide Super Thanks button` setting ([b0482c7](https://github.com/Francesco146/revanced-patches/commit/b0482c73271a8cae1c7da83153c935c061ab1431))
* **YouTube - Shorts overlay buttons:** Update `Outline` and `OutlineCircle` icons ([527681c](https://github.com/Francesco146/revanced-patches/commit/527681c2572231dd15660e765c7408efd5cef4f1))
* **YouTube - Shorts:** Add Original Outline Icons ([#663](https://github.com/Francesco146/revanced-patches/issues/663)) ([35a65f5](https://github.com/Francesco146/revanced-patches/commit/35a65f5e873bebc8ddf151cb194fe0d43f53022b))
* **YouTube - Shorts:** Rename ShortsOverlayButtonsPatch to ShortsActionButtonsPatch ([c3cf914](https://github.com/Francesco146/revanced-patches/commit/c3cf914c1b6c55d0e005d82077e639d59fb627d1))
* **YouTube - Sponsorblock:** Add content descriptions to `New Segment` buttons ([1deec38](https://github.com/Francesco146/revanced-patches/commit/1deec386beded1e2d685c3306a61ec8601691cb1))
* **YouTube - Spoof client:** Add `Show in Stats for nerds` setting ([b287a61](https://github.com/Francesco146/revanced-patches/commit/b287a61e480027689ea2ef792a84dcf1c9b002ab))
* **YouTube - Spoof client:** Selectively spoof client for general video / livestreams / Shorts / fallback (unplayable video) ([d92de62](https://github.com/Francesco146/revanced-patches/commit/d92de62fc05ba4df1343ddf270e78bd3f4e53e58))
* **YouTube - Spoof format stream data:** improve hook method, fetch to `ANDROID_TESTSUITE` client ([5a066dd](https://github.com/Francesco146/revanced-patches/commit/5a066ddafcfa459e5b2870bf4f307292e490a070))
* **YouTube - Start page:** Add `Playables` and `Courses / Learning` ([6c2c5b0](https://github.com/Francesco146/revanced-patches/commit/6c2c5b0060261dfaee47bf6c359b8db2ce9ce7ac))
* **YouTube - Swipe controls:** Add `Enable save and restore brightness` setting (Match to ReVanced) ([4fb9334](https://github.com/Francesco146/revanced-patches/commit/4fb9334c1597fea75aecd7873ee57d4a5360473a))
* **YouTube - Toolbar components:** Add `Hide image search button` settings ([457df98](https://github.com/Francesco146/revanced-patches/commit/457df9848340eec17c15f0fa6b156afe63c0975e))
* **YouTube - Toolbar components:** Remove `Hide trending searches` setting ([5d2e732](https://github.com/Francesco146/revanced-patches/commit/5d2e732b20f19fb95b9f91fe9d3409395543586c))
* **YouTube - Translations:** Add compile time option to select app languages ([6356ddc](https://github.com/Francesco146/revanced-patches/commit/6356ddc5d082c17f39b4f5cf92c2a31a5295aeed))
* **YouTube - Translations:** Add compile time option to select custom language file ([a65679e](https://github.com/Francesco146/revanced-patches/commit/a65679e2c345065b7fa96fa62f0901085cd3472d))
* **YouTube - Translations:** Add compile time option to select languages ([046a05e](https://github.com/Francesco146/revanced-patches/commit/046a05e5697b8a7f531e709803e9cb5709e5bbc3))
* **YouTube - Translations:** Remove unselected languages from UI ([b8d3946](https://github.com/Francesco146/revanced-patches/commit/b8d3946094caca123a6661ac17b01c28792683f1))
* **YouTube - Translations:** Update `Chinese Simplified` ([#471](https://github.com/Francesco146/revanced-patches/issues/471)) ([eb2fe8e](https://github.com/Francesco146/revanced-patches/commit/eb2fe8ec894ec6d0397ad06bbe7ad71f554dafcd))
* **YouTube - Translations:** Update `Chinese Simplified` ([#492](https://github.com/Francesco146/revanced-patches/issues/492)) ([e1113d9](https://github.com/Francesco146/revanced-patches/commit/e1113d91cc8af769988fc3a8c2df3062b06a7f3b))
* **YouTube - Translations:** Update `Chinese Simplified` ([#503](https://github.com/Francesco146/revanced-patches/issues/503)) ([ee4324b](https://github.com/Francesco146/revanced-patches/commit/ee4324bf39dfd2eca62044461cb3d7e845ab17d7))
* **YouTube - Translations:** Update `Chinese Traditional` ([#501](https://github.com/Francesco146/revanced-patches/issues/501)) ([0167c5d](https://github.com/Francesco146/revanced-patches/commit/0167c5d01d5974af16fc4d2a3fe3a5d0f3a5018d))
* **YouTube - Translations:** Update `Chinese Traditional` ([#666](https://github.com/Francesco146/revanced-patches/issues/666)) ([4f383eb](https://github.com/Francesco146/revanced-patches/commit/4f383eb45aa0610b1b27f039a718288ee193564a))
* **YouTube - Translations:** Update `Greek` ([#374](https://github.com/Francesco146/revanced-patches/issues/374)) ([5af0858](https://github.com/Francesco146/revanced-patches/commit/5af085861592182d23cfe5a451a41a5b70e9f908))
* **YouTube - Translations:** Update `Japanese` ([#457](https://github.com/Francesco146/revanced-patches/issues/457)) ([b993a5d](https://github.com/Francesco146/revanced-patches/commit/b993a5dc39380bb54e1b1dcac76cb94a2fa58394))
* **YouTube - Translations:** Update `Japanese` ([#467](https://github.com/Francesco146/revanced-patches/issues/467)) ([860073b](https://github.com/Francesco146/revanced-patches/commit/860073b48384dfcbedaf8de7e4f36261fa3e436f))
* **YouTube - Translations:** Update `Japanese` ([#504](https://github.com/Francesco146/revanced-patches/issues/504)) ([39a1863](https://github.com/Francesco146/revanced-patches/commit/39a1863cedbdc700fb70b38dd1e04475c539fdee))
* **YouTube - Translations:** Update `Korean` ([#464](https://github.com/Francesco146/revanced-patches/issues/464)) ([0770f09](https://github.com/Francesco146/revanced-patches/commit/0770f0944be9cc6bf26cd1218e056dade2990b83))
* **YouTube - Translations:** Update `Spanish` ([#436](https://github.com/Francesco146/revanced-patches/issues/436)) ([6e384d3](https://github.com/Francesco146/revanced-patches/commit/6e384d39ea8472b8f103045bb93f7e7bba80c668))
* **YouTube - Translations:** Update `Ukrainian` ([#400](https://github.com/Francesco146/revanced-patches/issues/400)) ([67c2895](https://github.com/Francesco146/revanced-patches/commit/67c289576459971d004e1cbb2d2b773918895d73))
* **YouTube - Translations:** Update `Ukrainian` ([#474](https://github.com/Francesco146/revanced-patches/issues/474)) ([70d9386](https://github.com/Francesco146/revanced-patches/commit/70d9386b3eb1a4774f9f3f2f394d3d02d29bea90))
* **YouTube - Translations:** Update `Ukrainian` ([#499](https://github.com/Francesco146/revanced-patches/issues/499)) ([2ec3c02](https://github.com/Francesco146/revanced-patches/commit/2ec3c02a4fd9a5280f621bfd065be53fe79a0a17))
* **YouTube - Translations:** Update `Ukrainian` ([#611](https://github.com/Francesco146/revanced-patches/issues/611)) ([dab2892](https://github.com/Francesco146/revanced-patches/commit/dab2892ca34dad17b5e21ce8a0516c9ac75897b9))
* **YouTube - VIsual preferences icons:** Add icons to `Player buttons` ([a07b8ec](https://github.com/Francesco146/revanced-patches/commit/a07b8ecd1184cc54d5c8bb0ae316496e62b27a42))
* **YouTube - Visual preferences icons:** Added more icons ([9dd62ce](https://github.com/Francesco146/revanced-patches/commit/9dd62ceacaeca8ab1b0b7c7c221e2cebc19a563f))
* **YouTube - Visual preferences icons:** RVX settings icon now changes even when the `Custom branding icon for YouTube` patch option is set to `YouTube` (unchanged) ([770b39b](https://github.com/Francesco146/revanced-patches/commit/770b39b6c08896041d7b227f6cb9cb8ddb2be1a5))
* **YouTube & Music - Custom branding icon:** Rename `Revancify Yellow` To `Xisr Yellow` ([#756](https://github.com/Francesco146/revanced-patches/issues/756)) ([26d7deb](https://github.com/Francesco146/revanced-patches/commit/26d7debb8d40013b65b66ac1d56f13c01755ea23))
* **YouTube & Music - Custom branding icon:** Update `Xisr Yellow` icon ([#755](https://github.com/Francesco146/revanced-patches/issues/755)) ([c1dfd1f](https://github.com/Francesco146/revanced-patches/commit/c1dfd1f20b777828f57c69bebb9d1f85190f8c7c))
* **YouTube & YouTube Music - Custom branding icon:** Updated `Revancify Yellow` icon  ([#689](https://github.com/Francesco146/revanced-patches/issues/689)) ([b86e084](https://github.com/Francesco146/revanced-patches/commit/b86e084b47da31aea5349d424902f5be11d4da99))
* **YouTube Music - Custom branding icon:** Add `MMT Blue`, `MMT Green` and `MMT Yellow` ([27b8aa7](https://github.com/Francesco146/revanced-patches/commit/27b8aa779642ef979ebd9448943cb8931dde647d))
* **YouTube Music - Custom branding icon:** Add `Revancify Yellow` header ([#670](https://github.com/Francesco146/revanced-patches/issues/670)) ([3dfcadb](https://github.com/Francesco146/revanced-patches/commit/3dfcadb2f1cdb7dafefe9f1337fc31f4d829a184))
* **YouTube Music - Custom branding icon:** Updated `AFN` icons ([#724](https://github.com/Francesco146/revanced-patches/issues/724)) ([700af02](https://github.com/Francesco146/revanced-patches/commit/700af022f47a70d9f611dc0e9555cfc2840992f6))
* **YouTube Music - Hide layout components:** Add `Hide settings menu` setting ([78b61dc](https://github.com/Francesco146/revanced-patches/commit/78b61dc799c4a3106a6800b176f464b8465b27d7))
* **YouTube Music - Player components:** Add `Enable black player background` settings ([c91be5a](https://github.com/Francesco146/revanced-patches/commit/c91be5a30b99bd46638f8a179c835c89e5c67a1f))
* **YouTube Music - Player components:** Add `Hide audio video switch toggle` setting ([9611f38](https://github.com/Francesco146/revanced-patches/commit/9611f38db290099f041eefe33896c423e1a1fecc))
* **YouTube Music - Player components:** Add settings `Disable miniplayer gesture`, `Disable player gesture` ([0bf84f9](https://github.com/Francesco146/revanced-patches/commit/0bf84f9d4cf3cad63b4cb6adbac1334be966e5ed))
* **YouTube Music - Thumbnails:** Add `Alternative domain` patch ([e51c9a4](https://github.com/Francesco146/revanced-patches/commit/e51c9a4d766cd8928449743dd8c6b09e30d0b945))
* **YouTube Music/Settings for YouTube Music:** add patch option `RVX settings menu name` ([e62e2d3](https://github.com/Francesco146/revanced-patches/commit/e62e2d375175bf40aac8135b40b554aa69466c65))
* **YouTube Music:** Add `Enable Cairo splash animation` patch (YouTube Music 7.06.53+) ([a09dd4c](https://github.com/Francesco146/revanced-patches/commit/a09dd4c47e6bebb50dfa35b7da0b1b76d073d8bc))
* **YouTube Music:** Add `Visual preferences icons` ([8672b10](https://github.com/Francesco146/revanced-patches/commit/8672b1001a3ccd34102261738cdeb031f97cf572))
* **YouTube Music:** Add support version `7.04.51` ([62b19b8](https://github.com/Francesco146/revanced-patches/commit/62b19b8ca17aab73852ef261458a31b27fbf6748))
* **YouTube Music:** add support version `7.05.52` ([91f9dd8](https://github.com/Francesco146/revanced-patches/commit/91f9dd8db139c16ff573702d54cb7c40315b3c5f))
* **YouTube Music:** add support version `7.05.53` ([9c1c0c9](https://github.com/Francesco146/revanced-patches/commit/9c1c0c9a65de4738fe505ece707386dbf83885ef))
* **YouTube Music:** Add support version `7.08.53` ([259682b](https://github.com/Francesco146/revanced-patches/commit/259682b7c0f59ecac0468ee0c7a067c85d5f6bdc))
* **YouTube Music:** Add support version `7.10.52` ([a842d17](https://github.com/Francesco146/revanced-patches/commit/a842d1743d13dac33db8ba0179f18289b4a8a742))
* **YouTube Music:** Add support version `7.11.51` ~ `7.12.51` ([b8a62ae](https://github.com/Francesco146/revanced-patches/commit/b8a62aeb0528f5ef513330ae5ef1790ffe4cd920))
* **YouTube Music:** Add support versions `7.01.53` - `7.02.51` ([71019ab](https://github.com/Francesco146/revanced-patches/commit/71019abba8c66f323b4cc948364bfa2a8d4c7fc8))
* **YouTube Music:** Add support versions `7.02.52` ~ `7.03.51` ([40df716](https://github.com/Francesco146/revanced-patches/commit/40df7164f7e465d03744b3a7e24fd8f9f1ac3584))
* **YouTube Music:** Add support versions `7.05.54` ~ `7.06.53` ([cc2bd1f](https://github.com/Francesco146/revanced-patches/commit/cc2bd1f060ee5c0282baaeedf64ba3473d50c4c2))
* **YouTube Music:** Add support versions `7.06.54` ~ `7.07.51` ([dc1e29a](https://github.com/Francesco146/revanced-patches/commit/dc1e29a77d06b72e6e48a3732b7f9ee305c53244))
* **YouTube Music:** Add support versions `7.07.52` ~ `7.08.52` ([11a668b](https://github.com/Francesco146/revanced-patches/commit/11a668b52a3469dc64bc1a253711ca213272e4cf))
* **YouTube Music:** Add support versions `7.08.54` ~ `7.10.51` ([0098528](https://github.com/Francesco146/revanced-patches/commit/009852881590e4a83038af29ce0f34b230d848a2))
* **YouTube Music:** Integrate `Hide double tap overlay filter` patch into the `Player components` patch ([9bd92bb](https://github.com/Francesco146/revanced-patches/commit/9bd92bb25e610c347f6b3c6712ade0fb2b553271))
* **YouTube Music:** Remove `Replace Cast button` patch ([b65a118](https://github.com/Francesco146/revanced-patches/commit/b65a118ffab3af71822295b746b332602f2c5373))
* **YouTube/Hide action buttons:** add `Disable Like and Dislike button glow` setting ([34d8bb1](https://github.com/Francesco146/revanced-patches/commit/34d8bb1abe32d3e56cd220ba0cf52555a85fabfe))
* **YouTube:** Add `Enable OPUS codec` patch ([f4684df](https://github.com/Francesco146/revanced-patches/commit/f4684dfd3d46eb19844761ff7818fa691cdbc543))
* **YouTube:** Add `Force disable Shorts dim` ([8a529ff](https://github.com/Francesco146/revanced-patches/commit/8a529ffe2efea270348d27d8c1970b02c12adea5))
* **YouTube:** Add `Force snackbar theme` ([2606187](https://github.com/Francesco146/revanced-patches/commit/2606187a0dca6fa3390a4d66931d70c927e893c9))
* **YouTube:** add `Miniplayer` patch (Replaces `Enable tablet mini player` patch) ([0e873ba](https://github.com/Francesco146/revanced-patches/commit/0e873bac39b5aba5072001744c8e9920b45a4d23))
* **YouTube:** Add `Spoof client` patch ([5161192](https://github.com/Francesco146/revanced-patches/commit/5161192ba2fbd3b25e081e573bf4428ec0d1b6c1))
* **YouTube:** Add `Watch history` patch ([f1fd6e6](https://github.com/Francesco146/revanced-patches/commit/f1fd6e68f19d9c6ba45efc081e7ac50d42ef8529))
* **YouTube:** Add content descriptions to improve accessibility ([468978c](https://github.com/Francesco146/revanced-patches/commit/468978c77d0b25ab1b70e70f80b3cb2ec678b546))
* **YouTube:** Add support version `19.20.35` ([45b5c5d](https://github.com/Francesco146/revanced-patches/commit/45b5c5dcb5cf7c6880ee4872a994373640e5b637))
* **YouTube:** add support version `19.21.40` ([5dfb419](https://github.com/Francesco146/revanced-patches/commit/5dfb4194030df04b163f017071489f6d22f31f46))
* **YouTube:** Add support version `19.23.40` ([19a14cd](https://github.com/Francesco146/revanced-patches/commit/19a14cd5d24c8867e1ee4c131f1e7a51763a1f11))
* **YouTube:** Add support version `19.25.39`, drop support version `19.23.40` ([7a5d939](https://github.com/Francesco146/revanced-patches/commit/7a5d9394cd7ddf3a05363bdb43611504c5872e97))
* **YouTube:** Add support versions `19.19.39` - `19.20.34` ([ee43c3e](https://github.com/Francesco146/revanced-patches/commit/ee43c3e25e1926e9963b9866bdb0c9e8bfe00a42))
* **YouTube:** DeArrow alternative domain ([#672](https://github.com/Francesco146/revanced-patches/issues/672)) ([ac46f0a](https://github.com/Francesco146/revanced-patches/commit/ac46f0af2f317629bb4e08bbcba16bb53516a975))
* **YouTube:** Drop support versions `19.17.41` ~ `19.25.39` ([e6b589b](https://github.com/Francesco146/revanced-patches/commit/e6b589b68ae7774b5104743670c4eb8be1d140cc))
* **YouTube:** Hide live chat replay button/label in fullscreen ([0cd9b96](https://github.com/Francesco146/revanced-patches/commit/0cd9b96c70a1eb5e17d9b3ee6ca81ce313a89eee))
* **YouTube:** Integrate `Change Shorts repeat state` patch into the `Shorts components` patch ([ccc69ec](https://github.com/Francesco146/revanced-patches/commit/ccc69ec8b501f3877db9f658f637dd272dccafb2))
* **YouTube:** Integrate `Hide double tap overlay filter` patch into the `Player components` patch ([d7ccd0d](https://github.com/Francesco146/revanced-patches/commit/d7ccd0dd352339d44f3e6330d6396876150b53c2))
* **YouTube:** Missing patches in the new RVX code ([#488](https://github.com/Francesco146/revanced-patches/issues/488)) ([3106111](https://github.com/Francesco146/revanced-patches/commit/310611110a198b7126b5f8037ccddbface263dc3))
* **YouTube:** Remove `Spoof format stream data` patch ([35aeec3](https://github.com/Francesco146/revanced-patches/commit/35aeec3e12c8adb64dcfe1396980b9722cf4ccaa))
* **YouTube:** Remove `Spoof test client` patch ([379e2ed](https://github.com/Francesco146/revanced-patches/commit/379e2ed903c537b674257251d71a132606ebf6b5))
* **YouTube:** Separate the `Bypass image region restrictions` patch from the `Alternative thumbnails` patch (Reflecting changes in ReVanced) ([5d41bff](https://github.com/Francesco146/revanced-patches/commit/5d41bffbeb93e22cc348ebd9f928b67ea506c92c))
* **YT Music - Translations:** Add compile time options to select custom language, RVX and app languages ([074d3e2](https://github.com/Francesco146/revanced-patches/commit/074d3e22c3a16e5c71ea6c7d514bfc11b4576406))


### Reverts

* default landscape mode timeout ([0d91401](https://github.com/Francesco146/revanced-patches/commit/0d914015accf4ef8a8d98fc607aead33620460ff))
